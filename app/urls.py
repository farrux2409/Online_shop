...
urlpatterns = [
    ...
    path('detail<int:pk>/order', order_product, name='order_by_id'),
    path('detail/<int:pk>', detail_product, name='detail'),
    path('add-product/', add_product, name='add_product'),
    path('detail/<int:product_id>/comment', add_comment, name='add_comment'),
    path('detail/<int:pk>/delete-product', delete_product, name='delete_product'),
    path('detail/<int:pk>/edit-product', edit_product, name='edit_product'),
